...
function FractalCanvas({
    ...
    useEffect(() => {
        ...
        const fractalProgram = createProgram(
            ...
            fractalFragmentShaderSource(equation, iterations, cutoff, colorScheme, zoom)
        );
    ...
    }, [equation, iterations, cutoff, zoom, offset, colorScheme, fxaaIntensity, setZoom, setOffset]);
